...
$app->get('sefaz/enviar-lote/{id}', 'Lotes@enviarById');
$app->get('sefaz/consultar-lote', 'Lotes@consultar');
$app->get('sefaz/consultar-lote/{id}', 'Lotes@consultarById');
...
$app->get('sefaz/enviar-consultar-gerar/{id}', 'Lotes@enviarConsultarGerarById');
